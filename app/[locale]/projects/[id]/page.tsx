   ...
   عرض المشروع
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
          {Array.from({ length: 9 }).map((_, index) => (
            <div
              key={index}
              className="bg-[#EFEDEA] border-2 border-[#20284D] shadow-lg overflow-hidden hover:scale-[1.02] transition-transform duration-300"
            >
              {/* Project Image */}
              <div className="relative h-[322px] border-b-2 border-[#20284D]">
                <Image
...
<div className="flex justify-center gap-12 mb-6">
  ...
  <div className="flex flex-col items-center gap-2">
    ...
    <span className="text-[#34222E] text-[16px]">250m</span>
  </div>

  {/* Bedrooms */}
  <div className="flex flex-col items-center gap-2">
    <Image src="/sizes/size2.png" alt="bedrooms" width={32} height={32} />
    <span className="text-[#34222E] text-[16px]">3</span>
  </div>

  {/* Bathrooms */}
  <div className="flex flex-col items-center gap-2">
    <Image src="/sizes/size1.png" alt="bathrooms" width={32} height={32} />
    <span className="text-[#34222E] text-[16px]">4</span>
  </div>

  {/* Parking */}
  <div className="flex flex-col items-center gap-2">
    <Image src="/sizes/size4.png" alt="parking" width={32} height={32} />
    <span className="text-[#34222E] text-[16px]">2</span>
  </div>
</div>
